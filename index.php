            ...
            <div class="site-menu__inner">
                ...
                <!-- <div class="menu">
                    <ul class="menu__list">
                        ...
                        <li class="menu__item"><span class="menu__count">03.</span><a href="" class="menu__link">Portfolio</a></li>
            ...
            <div class="hero__inner slider-wrapper swiper-wrapper">
                ...
                <div class="hero__content swiper-slide" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/hero-2@2x.jpg);">
                    ...
                    <div class="hero__text">
                        ...
                        <p class="hero__ingress">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae blanditiis placeat perspiciatis quas unde voluptas suscipit asperiores obcaecati sunt laboriosam?</p>
                    </div>
                
                    <div class="slider-description">
                        <div>
                            <h3 class="slider__title">Finally Florida gets their new beach villas</h3>
                            <p class="slider__text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium deserunt fuga facilis quisquam fugiat optio?</p>
                        </div>
                    </div>
                ...
                <div class="hero__content swiper-slide" style="background-image: url(<?php echo get_template_directory_uri(); ?>/assets/images/hero-3@2x.jpg);">
                    ...
                    <div class="hero__text">
                        ...
                        <p class="hero__ingress">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Doloribus quas quidem perferendis similique beatae.</p>
                    </div>
                
                    <div class="slider-description">
                        <div>
                            <h3 class="slider__title">Microsofts new HQ</h3>
                            <p class="slider__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio praesentium perspiciatis qui voluptatem similique.</p>
                        </div>
                    </div>
                ...
                <article class="featured">
                    ...
                    <div class="featured__project">
                        ...
                        <footer class="featured__footer">
                            <a href="" class="featured__explore">Explore Projects</a>
                        </footer>
            ...
            <div class="projects">
                ...
                <div class="swiper-wrapper">
                    ...
                    <article class="project swiper-slide">
                        ...
                        <div class="project__name"><strong>Project</strong> Beacj Villas, Coast</div>
                    </article>
